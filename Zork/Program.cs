...
namespace Zork
{
    class Program
    {
        ...
        private static void InitalizedRoomDescriptions()
        {
            ...
            roomMap["Rocky Trail"].Description = "You are on a rock-stewn trail.";
            ...
            roomMap["Clearing"].Description = "You are in a clearing, with a forest surronding you on the west and south.";
        }
