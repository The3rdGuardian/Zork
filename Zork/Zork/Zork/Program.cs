...
namespace Zork
{
    class Program
    {
        ...
        {
            Rooms[0, 0].Description = "You are on a rock-stewn trail.";                                                                             //Rocky Trail
            ...
            Rooms[2, 2].Description = "You are in a clearing, with a forest surronding you on the west and south.";                                 //Clearing
        }
